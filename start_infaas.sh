...
trap "echo; echo 'Stopping all INFaaS processes...'; kill $MODELREG_PID $QUERYFE_PID $WORKER_PID 2>/dev/null; pkill redis-server 2>/dev/null; echo 'Done.'; exit 0" INT TERM
wait
